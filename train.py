...
train_idx = np.random.randint(len(dataset_train), size=500)
test_idx = np.random.randint(len(dataset_test), size=200)
...
model_classes = {"GCN": models.GCN, "GCN Experimental": models.GCN_experimental}
