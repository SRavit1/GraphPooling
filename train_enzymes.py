...
epochs = 10
model_classes = {"GCN Model": models.GCN}

all_training_logs = {}
for (model_name, model_class) in model_classes.items():
  print("[INFO] Begin training for " + model_name + ".")
  ...
  training_logs = train(model, epochs, enzymes_train_loader, enzymes_test_loader, optimizer, loss_function, validate_frequency=2)
